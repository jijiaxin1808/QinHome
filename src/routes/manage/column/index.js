		...
		},
		{
			...
			render: (text, record, index) => (
				<div>
					{
						!edit[index] ?
            <>"             "<Button type="primary" onClick={() => handleEditClick(index)}>编辑</Button>"             "<Button type="danger" onClick={() => handleDelClick(index)}>删除</Button>"           "</>:
          ...
          >
            ...
            <div className={styles.tableHeader}>
            	...
            	<div className={styles.oper}>
            		{
            			!secColEdit ?
                  <>"                   "<Button onClick={handleRenameClick}>重命名</Button>"                   "<Button onClick={DelSecCol}>删除</Button>"                 "</>:
